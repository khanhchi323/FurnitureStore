    ...
    return (
        <div className=" bg-gray-100 pt-8 h-full">
            ...
            <div className="mx-auto justify-center px-6  xl:px-0m flex flex-col lg:flex lg:flex-row ">
                <div className="h-full lg:w-2/3">
                    <div className="rounded-lg bg-white shadow-md flex lg:w-full h-1/3 lg:mb-6 mb-2">
                        <div className=" justify-between  rounded-lg  p-6   flex  lg:">
                            <img src={Cabinet} alt="product-image" className=" rounded-lg w-52 h-52 shadow-md  " />
                        </div>
                    ...
                    <div className="rounded-lg bg-white shadow-md flex lg:w-full lg:mb-6 mb-2">
                        <div className=" justify-between  rounded-lg  p-6   flex  lg:">
                            <img src={Chair} alt="product-image" className=" rounded-lg w-52 h-52 shadow-md  " />
                        </div>
                        <div className="text-right w-full pr-4">
                            <p className="mt-5 text-lg self-center  font-bold text-gray-900">Cabinet Xám</p>
                            <p className="mt-3 text-xs text-gray-700">CAB-GR</p>
                ...
                {/* <!-- Sub total --> */}
                <div className=" mt-0 h-full  rounded-lg border bg-white p-4 shadow-md lg:w-1/3 lg:ml-8 ">
