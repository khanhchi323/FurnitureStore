    ...
    return (
        <div className="font-sans h-full w-full justify-center">
            <div className="text-center py-4 ">
                <b className="text-3xl">Create New Product</b>
            </div>
            <br />
                ...
                <div className="px-8 w-3/5 shadow pb-4">
                    ...
                    <div className="flex">
                        <div className="flex">
                            ...
                            <input className="mt-4 mx-2" type="checkbox" name="" id="" />
                        </div>
                        <div className="flex">
                    ...
                    <div className="text-sm mt-2 w-full flex ">
                        ...
                        <div className="w-full text-right">
                            <button className="bg-blue-400 text-white p-2 rounded" type="submit">Create</button>
                        </div>
                    </div>
                </div>
            </div>
